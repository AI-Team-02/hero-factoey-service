...
//    )
//    public CompletableFuture<Void> sendEmail(String recipientId, String subject, String content) {
...
//                helper.setTo(recipientId);
//                helper.setSubject(subject);
//                helper.setText(getEmailTemplate(content), true);
//
//                emailSender.send(message);
//                log.info("Email sent successfully to: {}", recipientId);
//
//            } catch (MailException e) {
//                log.error("Failed to send email to: {}, reason: {}", recipientId, e.getMessage());
//                throw e;
//            } catch (MessagingException e) {
//                log.error("Error creating email message for: {}, reason: {}", recipientId, e.getMessage());
